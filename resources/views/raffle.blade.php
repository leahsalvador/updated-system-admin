                ...
                <div class="order-last order-md-first mt-4 mt-md-0">
                    <div class="card border-white card-home card-nav px-3">
                        <div class="card-header px-0 py-3">
                            <h5 class="fw-bold mb-0"><img class="me-2" src="{{url('icon%20-%20raffle%20ticket.png') }}">Raffle Tickets</h5>
                        </div>
                        <div class="card-body px-0 py-2">
                            <p class="card-text mb-0" style="font-size: 14px;">Total Awarded</p>
                            <h3 class="fw-bold text-success card-text">32</h3>
                        </div>
                    </div>
                </div>
                <div>
            ...
            <div class="card-table px-4 py-3">
                ...
                <div class="d-flex flex-column flex-lg-row justify-content-lg-between custom-tabs-search pb-2">
                    <ul class="nav nav-tabs text-capitalize fs-5 fw-bolder custom-tabs" role="tablist">
                        <li class="nav-item" role="presentation"><a class="nav-link active active-pending py-1" role="tab" data-bs-toggle="tab" href="#tab-1">Active</a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link active-approved py-1" role="tab" data-bs-toggle="tab" href="#tab-2">Used</a></li>
                    </ul>
